...
if uploaded_file:
    ...
    if st.button("🔎 Get Job Recommendations"):
        ...
        with st.spinner("Fetching job keywords..."):
            keywords = ask_llm(
                f"Based on this resume summary, suggest best job titles and keywords for searching jobs. Give comma-separated list only.\n\nSummary: {summary}",
                max_tokens=100
            )
